...
public class InventoryEditor extends AppCompatActivity implements
    ...
    private View.OnClickListener minusAction = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            String stockString = mProductInventory.getText().toString().trim();
            int stockLevel;
            ...
            if (stockLevel > 0) {
                ...
                mProductInventory.setText(String.valueOf(stockLevel));
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Cast UI
        mImageView = (ImageView) findViewById(R.id.image_product_photo);
        mProductName = (EditText) findViewById(R.id.edit_product_name);
        mProductDescription = (EditText) findViewById(R.id.edit_product_description);
        mProductInventory = (EditText) findViewById(R.id.edit_product_stock);
        mItemSold = (EditText) findViewById(R.id.edit_product_sales);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PICK_PHOTO_REQUEST && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                mCurrentPhotoUri = mImageUri.toString();
                mImageView.setImageBitmap(Utils.getBitmapFromUri(mImageUri, mContext, mImageView));
            }
        }
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mImageView.setImageBitmap(Utils.getBitmapFromUri(Uri.parse(mCurrentPhotoUri), mContext, mImageView));
            mImageUri = Uri.parse(mCurrentPhotoUri);
        }
    ...
    private void saveProduct() {
        ...
        if (TextUtils.isEmpty(nameString) || TextUtils.isEmpty(inventoryString) || mCurrentPhotoUri == null
